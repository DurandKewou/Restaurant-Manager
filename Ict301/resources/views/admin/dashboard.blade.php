                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($reservation->status == false)
                                                        <form id="status-form-{{ $reservation->id }}" action="{{ route('reserver.status',$reservation->id) }}" style="display: none;" method="POST">
                                                            @csrf
                                                        </form>
                                                    ...
                                                    @endif
                                                    <form id="delete-form-{{ $reservation->id }}" action="{{ route('reserva.destory',$reservation->id) }}" style="display: none;" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
